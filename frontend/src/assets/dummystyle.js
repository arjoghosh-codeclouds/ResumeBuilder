export const landingPageStyles = {
  ...
  logoIcon: "w-10 h-10 bg-gradient-to-br from-red-500 to-red-700 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-200",
  logoIconInner: "w-5 h-5 text-white",
  logoText: "text-xl sm:text-2xl font-black bg-gradient-to-r from-pink-600 to-pink-800 bg-clip-text text-transparent",
  mobileMenuButton: "md:hidden p-2 rounded-xl hover:bg-violet-50 transition-colors",
  mobileMenuIcon: "text-gray-800",

  // Auth buttons
  desktopAuthButton: "relative group px-6 sm:px-8 py-2 sm:py-3 bg-red-500 text-white font-bold rounded-2xl overflow-hidden transition-all hover:bg-red-500",
  desktopAuthButtonText: "relative",
  desktopAuthButtonOverlay: "absolute inset-0 bg-gradient-to-r from-red-500 to-red-700 opacity-0 group-hover:opacity-100 transition-opacity",
  
  
  // Mobile menu
  mobileMenu: "md:hidden bg-white/95 backdrop-blur-lg w-full fixed top-16 left-0 right-0 z-40 shadow-lg border-b border-black transition-all duration-300 ease-in-out",
  mobileMenuContainer: "max-w-6xl mx-auto px-4 sm:px-6 py-4 flex flex-col gap-4",
  mobileUserInfo: "flex flex-col gap-4 py-2",
  mobileUserWelcome: "text-red-500 font-medium text-center py-2 text-base sm:text-lg",
  mobileDashboardButton: "w-full px-6 py-3 bg-red-500 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-violet-200/50 transition-all",
  mobileAuthButton: "w-full px-6 py-3 bg-gradient-to-r from-gray-600 to-gray-800 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-violet-200/50 transition-all",
  // Main content
  main: "pt-24",
  ...
  headingText: "block text-gray-800",
  headingGradient: "block bg-gradient-to-r from-red-600 via-gray-600 to-red-800 bg-clip-text text-transparent",
  ...
  // Buttons
  primaryButton: "group relative px-10 py-4 bg-red-500 text-white font-bold rounded-2xl overflow-hidden transition-all hover:scale-105 hover:bg-white-500",
  primaryButtonOverlay: "absolute inset-0 bg-gradient-to-r from-gray-600 to-gray-800 opacity-0 group-hover:opacity-100 transition-opacity bg-white",
  ...
  secondaryButton: "px-8 sm:px-10 py-3 sm:py-4 border-2 border-black-600 text-red-700 font-bold rounded-2xl hover:border-violet-300 hover:bg-violet-50 transition-all",
  ...
  featureIconContainer: "w-16 h-16 sm:w-20 sm:h-20 bg-red-500 rounded-2xl flex items-center justify-center mb-4 sm:mb-6 text-white shadow-lg",
...
export const dashboardStyles = {
  ...
  // New Resume Card
  newResumeCard: "flex flex-col items-center justify-center bg-gradient-to-br from-violet-50 to-blue-50 border-2 border-dashed border-red-500 rounded-2xl p-6 cursor-pointer transition-all hover:shadow-lg hover:border-red-700 h-full",
  newResumeIcon: "w-16 h-16 rounded-full bg-red-500 flex items-center justify-center mb-4",
...
export const cardStyles = {
  ...
  // Action buttons
  actionOverlay: "absolute inset-4 sm:inset-6  to-transparent flex items-end justify-center p-6 opacity-0 group-hover:opacity-100 transition-all duration-300 rounded-2xl",
  actionButtonsContainer: "flex gap-3",
  editButton: "group/btn w-12 h-12 flex items-center justify-center bg-red-500 rounded-2xl shadow-md hover:scale-110 transition-all duration-300",
...
export const authStyles = {
  ...
  submitButton: "w-full py-4 bg-red-500 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-red-500 transition-all text-lg",
  ...
  signupSubmit: "w-full py-4 bg-red-500 text-white font-black rounded-2xl hover:scale-105 hover:shadow-xl hover:shadow-rose-200 transition-all text-lg",
  signupSwitchButton: "font-black text-red-500 hover:text-pink-600 transition-colors"
};
...
export const containerStyles = {
  ...
  formContainer: "bg-slate-950 border border-violet-100 rounded-2xl overflow-hidden shadow-sm",
  previewContainer: "bg-black border border-violet-100 rounded-2xl overflow-hidden shadow-sm p-4",
...
export const buttonStyles = {
  ...
  back: "flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gray-100 text-blue-700 font-bold rounded-xl hover:bg-gray-200 transition-all text-sm",
  save: "flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-gray-100 border border-black text-red-500 font-bold rounded-xl hover:bg-gray-200 transition-all text-sm",
  next: "flex items-center gap-2 px-4 sm:px-6 py-2 sm:py-3 bg-red-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg text-sm",
...
export const modalStyles = {
  ...
  actionButton: "flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-red-500 to-red-500 text-white font-bold rounded-xl hover:scale-105 transition-all shadow-lg mr-12",
